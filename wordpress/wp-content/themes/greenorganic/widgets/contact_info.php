    ...
    <div class="media email-info pull-right">
        <?php if ( $email_icon ) { ?>
            <div class="media-left media-middle">
                <div class="icon">
                    <img src="<?php echo esc_url($email_icon); ?>" alt="<?php esc_attr_e('Image', 'greenorganic'); ?>">
                </div>
            </div>
        <?php } ?>
...
if ( $phone_icon != '' || $phone_content != '' ) {
    ...
    <div class="media phone-info pull-right">
        <?php if ( $phone_icon ) { ?>
            <div class="media-left media-middle">
                <div class="icon">
                <img src="<?php echo esc_url($phone_icon); ?>" alt="<?php esc_attr_e('Image', 'greenorganic'); ?>">
                </div>
            </div>
        <?php } ?>
        <div class="media-body">
...
if ( $address_icon != '' || $address_content != '' ) {
    ...
    <div class="media address-info pull-right">
        <?php if ( $address_icon ) { ?>
            <div class="media-left media-middle">
                <div class="icon">
                <img src="<?php echo esc_url($address_icon); ?>" alt="<?php esc_attr_e('Image', 'greenorganic'); ?>">
                </div>
            </div>
        <?php } ?>
        <div class="media-body">
