...
<form id="add_payment_method" method="post">
	<div id="payment" class="widget">
		<ul class="payment_methods methods clear-list">
			<?php
				if ( $available_gateways = WC()->payment_gateways->get_available_payment_gateways() ) {
					...
					echo '<p>' . esc_html__( 'Sorry, it seems that there are no payment methods which support adding a new payment method. Please contact us if you require assistance or wish to make alternate arrangements.', 'greenorganic' ) . '</p>';
		...
		<div class="form-group">
			...
			<input type="submit" class="button alt" id="place_order" value="<?php esc_html_e( 'Add Payment Method', 'greenorganic' ); ?>" />
