...
<head>
	...
	if ( !function_exists( 'wp_site_icon' ) ) {
		$favicon = greenorganic_get_config('media-favicon');
...
<body <?php body_class(); ?>>
<?php if ( greenorganic_get_config('preload', true) ) { ?>
...
<div id="wrapper-container" class="wrapper-container">
	...
	<?php $header = apply_filters( 'greenorganic_get_header_layout', greenorganic_get_config('header_type') );
		if ( empty($header) ) {
			$header = 'default';
		}
	?>
