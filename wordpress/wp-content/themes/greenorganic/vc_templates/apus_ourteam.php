...
?>
	<div class="widget widget-ourteam <?php echo esc_attr($el_class); ?>">
	    ...
	    <div class="widget-content"> 
			<div class="owl-carousel products" data-items="<?php echo esc_attr($columns); ?>" data-smallmedium="2" data-extrasmall="2" data-carousel="owl" data-pagination="false" data-nav="true">
