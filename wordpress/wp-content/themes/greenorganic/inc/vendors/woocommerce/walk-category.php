<?php
/**
 * Greenorganic_WC_Product_Cat_Dropdown_Walker class
 *
 * @extends 	Walker
 * @class 		Greenorganic_WC_Product_Cat_Dropdown_Walker
 * @version		1.6.4
...
if ( ! class_exists( 'Greenorganic_WC_Product_Cat_Dropdown_Walker', false ) ) :

class Greenorganic_WC_Product_Cat_Dropdown_Walker extends Walker {
