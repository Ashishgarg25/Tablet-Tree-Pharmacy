...
if ( !function_exists( 'greenorganic_autocomplete_search' ) ) {
    function greenorganic_autocomplete_search() {
        if ( greenorganic_get_config('enable_autocompleate_search', true) ) {
            ...
            add_action( 'wp_ajax_greenorganic_autocomplete_search', 'greenorganic_autocomplete_suggestions' );
            add_action( 'wp_ajax_nopriv_greenorganic_autocomplete_search', 'greenorganic_autocomplete_suggestions' );
        }
    }
}
add_action( 'init', 'greenorganic_autocomplete_search' );

if ( !function_exists( 'greenorganic_autocomplete_suggestions' ) ) {
    function greenorganic_autocomplete_suggestions() {
