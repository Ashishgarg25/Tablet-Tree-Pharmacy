...
if ( !class_exists("Greenorganic_Mobile_Menu") ) {
    class Greenorganic_Mobile_Menu extends Walker_Nav_Menu {
        ...
        public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
            ...
            if ( isset($item->apus_text_label) && !empty($item->apus_text_label) ) {
                switch ( $item->apus_text_label ) {
                    case 'label_new':
                        $text_label  = esc_html__('New', 'greenorganic');
                        break;

                    case 'label_hot':
                        $text_label  = esc_html__('Hot', 'greenorganic');
                        break;

                    case 'label_featured':
                        $text_label  = esc_html__('Featured', 'greenorganic');
                        break;
