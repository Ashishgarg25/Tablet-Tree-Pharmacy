...
class Greenorganic_Recent_Post extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_recent_post',
            esc_html__('Apus Recent Posts Widget', 'greenorganic'),
            array( 'description' => esc_html__( 'Show list of recent post', 'greenorganic' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('post_type')); ?>">
                <?php echo esc_html__('Type:', 'greenorganic' ); ?>
            </label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'number_post' )); ?>"><?php esc_html_e( 'Num Posts:', 'greenorganic' ); ?></label>
...
register_widget( 'Greenorganic_Recent_Post' );