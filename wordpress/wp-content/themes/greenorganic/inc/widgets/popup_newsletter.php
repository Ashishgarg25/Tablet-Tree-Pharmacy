...
class Apusbase_Apus_Popup_Newsletter extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            ...
            esc_html__('Apus Popup Newsletter Widget', 'greenorganic'),
            array( 'description' => esc_html__( 'Show Popup Newsletter', 'greenorganic' ), )
        );
    ...
    public function form( $instance ) {
        ...
        ?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><strong><?php esc_html_e('Title:', 'greenorganic');?></strong></label>
        ...
        <label for="<?php echo esc_attr($this->get_field_id( 'image' )); ?>"><?php esc_html_e( 'Image:', 'greenorganic' ); ?></label>
        <div class="screenshot">
            <?php if ( $instance['image'] ) { ?>
                <img src="<?php echo esc_url($instance['image']); ?>" style="max-width:100%" alt="<?php esc_attr_e('Image', 'greenorganic'); ?>"/>
            <?php } ?>
        </div>
