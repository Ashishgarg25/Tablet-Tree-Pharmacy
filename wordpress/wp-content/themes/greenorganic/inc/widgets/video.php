...
class Greenorganic_Featured_Video_Widget extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            // Base ID of your widget
            'apus_featured_video_widget',
            // Widget name will appear in UI
            esc_html__('Apus Featured Video Widget', 'greenorganic'),
             // Widget description
            array( 'description' => esc_html__( 'Show Featured video', 'greenorganic' ),)
        );
    ...
    public function form( $instance ) {
        ...
        ?>
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php echo esc_html__('Title:', 'greenorganic' ); ?></label>
            <br>
            <input class="widefat" id="<?php echo esc_attr( $this->get_field_id('title') ); ?>" name="<?php echo  esc_attr($this->get_field_name('title')); ?>" type="text" value="<?php echo esc_attr($instance['title']); ?>" />
        </p>
        <p>
            <label for="<?php echo  esc_attr($this->get_field_id( 'video_link' )); ?>"><?php echo esc_html__('Video link:', 'greenorganic' ); ?></label>
            <br>
            ...
            <br>
            <?php echo esc_html__('Support video from Youtube and Vimeo link. Ex: https://www.youtube.com/watch?v=sd0grLQ4voU', 'greenorganic' ); ?>
        </p>
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id('video_name') ); ?>"><?php echo esc_html__('Video name:', 'greenorganic' ); ?></label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id('video_width')); ?>"><?php echo esc_html__('Video width:', 'greenorganic'); ?></label>
            <br>
...
register_widget( 'Greenorganic_Featured_Video_Widget' );