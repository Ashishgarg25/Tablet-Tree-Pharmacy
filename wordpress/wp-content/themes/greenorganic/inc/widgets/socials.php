...
class Greenorganic_Socials_Widget extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_socials_widget',
            esc_html__('Apus Socials', 'greenorganic'),
            array( 'description' => esc_html__( 'Socials for website.', 'greenorganic' ), )
        );
    ...
    public function scripts() {
        wp_enqueue_script( 'greenorganic-script-admin-js', get_template_directory_uri().'/js/admin/admin.js', array( 'jquery' ), APUS_FRAMEWORK_VERSION, true );
    }
    ...
    <div class="apus_socials">
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'socials' )); ?>"><?php esc_html_e('Select socials:', 'greenorganic'); ?></label>
            <br>
        <?php
...
register_widget( 'Greenorganic_Socials_Widget' );