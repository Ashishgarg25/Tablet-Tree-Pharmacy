...
class Greenorganic_Custom_Menu extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_custom_menu',
            esc_html__('Apus Custom Menu Widget', 'greenorganic'),
            array( 'description' => esc_html__( 'Show custom menu', 'greenorganic' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('nav_menu')); ?>">
                <?php echo esc_html__('Menu:', 'greenorganic' ); ?>
            </label>
            <br>
...
register_widget( 'Greenorganic_Custom_Menu' );