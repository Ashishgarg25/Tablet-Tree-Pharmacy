...
class Greenorganic_Search extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_search',
            esc_html__('Apus Search Widget', 'greenorganic'),
            array( 'description' => esc_html__( 'Show search form in sidebar', 'greenorganic' ), )
        );
...
register_widget( 'Greenorganic_Search' );