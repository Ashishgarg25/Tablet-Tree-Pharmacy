...
class Greenorganic_Widget_Contact_Info extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_contact_info',
            esc_html__('Apus Contact Info Widget', 'greenorganic'),
            array( 'description' => esc_html__( 'Show Contact Info', 'greenorganic' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <div class="address-wrapper">
            ...
            <label for="<?php echo esc_attr($this->get_field_id( 'address_icon' )); ?>"><?php esc_html_e( 'Icon:', 'greenorganic' ); ?></label>
            <div class="screenshot">
                <?php if ( $instance['address_icon'] ) { ?>
                    <img src="<?php echo esc_url($instance['address_icon']); ?>" style="max-width:100%" alt="<?php esc_attr_e('Image', 'greenorganic'); ?>"/>
                <?php } ?>
            </div>
            ...
            <!-- social -->
            <p>
                <label for="<?php echo esc_attr($this->get_field_id( 'address_content' )); ?>"><strong><?php esc_html_e('Address Content:', 'greenorganic');?></strong></label>
        ...
        <div class="phone-wrapper">
            ...
            <label for="<?php echo esc_attr($this->get_field_id( 'phone_icon' )); ?>"><?php esc_html_e( 'Icon:', 'greenorganic' ); ?></label>
            <div class="screenshot">
                <?php if ( $instance['phone_icon'] ) { ?>
                    <img src="<?php echo esc_url($instance['phone_icon']); ?>" style="max-width:100%" alt="<?php esc_attr_e('Image', 'greenorganic'); ?>"/>
                <?php } ?>
            </div>
            ...
            <!-- social -->
            <p>
                <label for="<?php echo esc_attr($this->get_field_id( 'phone_content' )); ?>"><strong><?php esc_html_e('Phone Content:', 'greenorganic');?></strong></label>
        ...
        <div class="email-wrapper">
            ...
            <label for="<?php echo esc_attr($this->get_field_id( 'email_icon' )); ?>"><?php esc_html_e( 'Icon:', 'greenorganic' ); ?></label>
            <div class="screenshot">
                <?php if ( $instance['email_icon'] ) { ?>
                    <img src="<?php echo esc_url($instance['email_icon']); ?>" style="max-width:100%" alt="<?php esc_attr_e('Image', 'greenorganic'); ?>"/>
                <?php } ?>
            </div>
            ...
            <!-- social -->
            <p>
                <label for="<?php echo esc_attr($this->get_field_id( 'email_content' )); ?>"><strong><?php esc_html_e('Email Content:', 'greenorganic');?></strong></label>
...
register_widget( 'Greenorganic_Widget_Contact_Info' );