...
class Greenorganic_Posts extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            // Base ID of your widget
            'apus_posts',
            // Widget name will appear in UI
            esc_html__('Apus Posts Widget', 'greenorganic'),
            // Widget description
            array( 'description' => esc_html__( '', 'greenorganic' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'ids' )); ?>"><?php echo esc_html__( 'Posts:', 'greenorganic' ); ?></label>
            <br>
...
register_widget( 'Greenorganic_Posts' );