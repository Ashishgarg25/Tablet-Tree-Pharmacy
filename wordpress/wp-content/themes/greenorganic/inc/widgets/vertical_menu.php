...
class Greenorganic_Vertical_Menu extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_vertical_menu',
            esc_html__('Apus Vertical Menu Widget', 'greenorganic'),
            array( 'description' => esc_html__( 'Show Vertical Menu', 'greenorganic' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            ...
            <select name="<?php echo esc_attr($this->get_field_name( 'nav_menu' )); ?>" id="<?php echo esc_attr($this->get_field_id( 'nav_menu' )); ?>">
                <option value="" <?php selected( $instance['nav_menu'], $menu->slug ); ?>> <?php esc_html_e('--- Select Menu ---', 'greenorganic'); ?></option>
        ...
        <p>
            ...
            <select name="<?php echo esc_attr($this->get_field_name( 'position' )); ?>" id="<?php echo esc_attr($this->get_field_id( 'position' )); ?>">
                <option value="left" <?php selected( $instance['position'], 'left' ); ?>><?php esc_html_e( 'Left', 'greenorganic' ); ?></option>
                <option value="right" <?php selected( $instance['position'], 'right' ); ?>><?php esc_html_e( 'Right', 'greenorganic' ); ?></option>
            </select>
        </p>
<?php
    }
...
register_widget( 'Greenorganic_Vertical_Menu' );