...
class Greenorganic_Recent_Comment extends Apus_Widget {
    public function __construct() {
        parent::__construct(
            'apus_recent_comment',
            esc_html__('Apus Recent Comments Widget', 'greenorganic'),
            array( 'description' => esc_html__( 'Show list of recent comments', 'greenorganic' ), )
        );
    ...
    public function form( $instance ) {
        if ( isset( $instance[ 'title' ] ) ) {
            ...
            $title = esc_html__( 'Latest Post', 'greenorganic' );
        }
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'number_comment' )); ?>"><?php esc_html_e( 'Num Comments:', 'greenorganic' ); ?></label>
...
register_widget( 'Greenorganic_Recent_Comment' );