<?php
    $relate_count = greenorganic_get_config('number_blog_releated', 3);
    $relate_columns = greenorganic_get_config('releated_blog_columns', 3);
...
<div class="related-posts">
    <h4 class="title">
        <span><?php esc_html_e( 'Related Posts', 'greenorganic' ); ?></span>
    </h4>
