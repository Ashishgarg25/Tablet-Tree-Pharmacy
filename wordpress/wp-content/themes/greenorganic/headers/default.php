<header id="apus-header" class="apus-header header-default hidden-sm hidden-xs" role="banner">
    <?php if(is_active_sidebar( 'sidebar-slogan' ) || is_active_sidebar( 'sidebar-socials' ) || ( greenorganic_get_config('show_settingmenu') && has_nav_menu( 'top-menu' ) ) ) {?>
                    ...
                    <div class="p-relative">
                        <div class="row">
                            <div class="table-visiable-dk">
                                ...
                                <div class="col-xs-12 p-static <?php if (( defined('GREENORGANIC_WOOCOMMERCE_ACTIVED') && greenorganic_get_config('show_cartbtn') ) || greenorganic_get_config('show_searchform') ) echo 'col-md-7 col-sm-8'; ?>">
                                    <div class="main-menu">
